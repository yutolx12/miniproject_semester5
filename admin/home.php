...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $sql = "INSERT INTO data_sensor (temp1, hum1, ldr, soilm) VALUES ('$temp', '$hum','$ldr', '$soilm')";
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container-fluid">
      ...
      <a class="navbar-brand me-auto ms-lg-0 ms-3 text-uppercase fw-bold" href="#">MOP Green
      </a>
    ...
    <div class="card col-lg-4 col-md-4 col-sm-4 bg-dark">
      <div class="card-body">
        <div class="row text-white">
          ...
          <div class="col-lg-6 col-md-6 col-sm-6 col-12 klt">
            <strong>PH Tanah</strong>
            <h3 id="hitSM"> <span>pH</span></h3>
          </div>
          <!--           <div class="col-lg-3 col-md-3 col-sm-3 col-12 sht">
            <strong>Suhu 2</strong>
            <h3 id="hitTEMP2">&deg;</h3>
...
<script src="js/dataTables.bootstrap5.min.js"></script> -->
  ...
  -----------------------------------------------------*/
    ...
    client.onMessageArrived = function(message) {
      ...
      document.getElementById("hitLDR").innerHTML = ldr + " cd";
      document.getElementById("hitSM").innerHTML = soilm + " pH";
      ...
      fetch('http://localhost/MOP-Green-newest/admin/home.php', {
          method: 'POST', // or 'PUT'
          //   headers: {
